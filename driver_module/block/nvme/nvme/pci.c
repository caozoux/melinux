...
static int nvme_cmb_qdepth(struct nvme_dev *dev, int nr_io_queues, int entry_size);
...
static int nvme_dev_map(struct nvme_dev *dev)
{
	...
	trace_printk("zz %s bars:%lx \n",__func__, (unsigned long)bars);
                        ...
                        struct nvme_command *cmd)
{
    ...
    if (nvmeq->sq_cmds_io)
        memcpy_toio(&nvmeq->sq_cmds_io[tail], cmd, sizeof(*cmd)); //--> check
    else
